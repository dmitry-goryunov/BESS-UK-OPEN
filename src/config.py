...
Asset: 100 MW / 200 MWh fast-cycle LFP, GB, 2h duration, 2025 vintage.
...
ASSET = {
    ...
    "energy_mwh":           200.0,    # MWh nameplate capacity (2h duration)
    "duration_h":             2.0,    # energy_mwh / power_mw
...
ASSET["soc_min_mwh"]  = ASSET["soc_min_frac"]  * ASSET["energy_mwh"]    # 20 MWh
ASSET["soc_max_mwh"]  = ASSET["soc_max_frac"]  * ASSET["energy_mwh"]    # 180 MWh
ASSET["soc_init_mwh"] = ASSET["soc_init_frac"] * ASSET["energy_mwh"]    # 100 MWh
ASSET["capex_gbp"]    = ASSET["capex_gbp_kwh"] * ASSET["energy_mwh"] * 1000  # 44m GBP
